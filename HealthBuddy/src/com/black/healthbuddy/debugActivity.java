...
public class debugActivity extends Activity implements OnClickListener {
	private static final Logger logger = Logger.getLogger(debugActivity.class.getSimpleName());
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "debugActivity");

		if (stepServiceIntent==null) {
			Bundle extras = new Bundle();
			extras.putInt("int", 1);
			stepServiceIntent = new Intent(debugActivity.this, StepService.class);
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			try {
				if (mService!=null && mService.isRunning()) {
					MessageUtilities.confirmUser(   debugActivity.this, 
