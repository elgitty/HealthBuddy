 ...
 */
public class CalBurntConsumedChart extends AbstractDemoChart {
...
/**
  ...
  public Intent execute(Context context) {
    ...
    String[] titles = new String[] { "Calories Burnt", "Calories Consumed" };
    ...
    renderer.addXTextLabel(1, "Wed");
    renderer.addXTextLabel(2, "Thur");
    renderer.addXTextLabel(3, "Fri");
    renderer.addXTextLabel(4, "Sat");
